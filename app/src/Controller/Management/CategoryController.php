...
#[Route('/management/categories', name: 'management_category_')]
class CategoryController extends AbstractController
{
    ...
    #[Route('/{category}', name: 'edit', requirements: ['category' => '\d+'])]
    ...
    #[Route('/{category}/delete', name: 'delete', requirements: ['category' => '\d+'])]
